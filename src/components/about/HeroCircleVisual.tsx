    ...
    <div className="relative mx-auto h-[min(92vw,400px)] w-[min(92vw,400px)] sm:h-[440px] sm:w-[440px] lg:h-[480px] lg:w-[480px] xl:h-[520px] xl:w-[520px]">
      ...
      <div className="absolute inset-[10%] overflow-hidden rounded-full shadow-[0_28px_70px_rgba(6,43,99,0.22)] ring-2 ring-[#C9A24A]/75 sm:ring-[3px]">
        <StaticPicture
          ...
          priority
          imgClassName="h-full w-full scale-105 object-cover object-[center_18%]"
        />
      </div>
      ...
      <StaticPicture
        ...
        priority
        className="pointer-events-none absolute -bottom-[16%] left-1/2 z-20 h-[90%] w-auto max-w-[115%] -translate-x-1/2 sm:-bottom-[18%] sm:h-[94%] lg:-bottom-[20%] lg:max-w-[110%]"
        imgClassName="h-full w-auto object-contain object-bottom"
      />
    </div>
  )
}
